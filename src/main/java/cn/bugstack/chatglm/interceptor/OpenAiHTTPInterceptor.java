...
public class OpenAiHTTPInterceptor implements Interceptor {
    ...
    private static final String ifAccept="sse-invoke";
    ...
    public @NotNull Response intercept(Chain chain) throws IOException {
        ...
        Request request = original.newBuilder()
                ...
                .header("Accept", ifAccept(original.url().toString())?Configuration.SSE_CONTENT_TYPE:Configuration.APPLICATION_JSON)
    ...
    private boolean ifAccept(String url){
        return url.contains(ifAccept);
    }
