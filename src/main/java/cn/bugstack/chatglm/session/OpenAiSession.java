...
public interface OpenAiSession {
    ...
    ChatCompletionResponse completions(ChatCompletionRequest chatCompletionRequest) throws JsonProcessingException;

    CharInvokeCompletionResponse completionInvoke(ChatCompletionRequest chatCompletionRequest);
}
