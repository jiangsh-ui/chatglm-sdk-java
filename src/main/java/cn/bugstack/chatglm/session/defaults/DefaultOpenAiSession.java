...
public class DefaultOpenAiSession implements OpenAiSession {
    ...
    @Override
    public ChatCompletionResponse completions(ChatCompletionRequest chatCompletionRequest) throws JsonProcessingException {
        return this.openAiApi.completions(chatCompletionRequest.getModel().getCode(), chatCompletionRequest).blockingGet();
    }

    @Override
    public CharInvokeCompletionResponse completionInvoke(ChatCompletionRequest chatCompletionRequest) {
        return this.openAiApi.completionsInvoke(chatCompletionRequest.getModel().getCode(), chatCompletionRequest).blockingGet();
    }
